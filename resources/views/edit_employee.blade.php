...
@section('sliderbar')
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item"><a href="{{ route('admin.employees.index') }}" class="nav-link">Employee</a></li>
        </ul>
@endsection
...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Edit Employee Form') }}
        </h2>
    </x-slot>
<form action="{{ route('admin.employees.update',$emp->id) }}" method="POST" id="Update_emp_form">
@csrf
@method('PUT')
<div class="row">
    <div class="form-group">
        <div class="col-md-12  pt-3">
            ...
            <input type="text" name="full_name" id="full_name" class="form-control" placeholder="Full Name" value="{{ $emp->full_name }}">
        ...
        <div class="col-md-12 pt-3">
            ...
            <input type="email" name="email" id="email" class="form-control" placeholder="Email" value="{{ $emp->email }}">
        ...
        <div class="col-md-12 pt-3">
            ...
            <input type="text" name="phone" id="phone" class="form-control" placeholder="Phone Number" value="{{ $emp->phone }}">
        ...
        <div class="col-md-12 pt-3">
            ...
            <input type="text" name="designation" id="designation" class="form-control" placeholder="Designation" value="{{ $emp->designation }}">
        ...
        <button type="button" class="btn btn-primary" value="Update" onclick="Update_emp_form()">Update</button>
        </div>
    </div>
</div>
    </form>
